...
//open-mobil-dropdown
let menuArrows = document.querySelectorAll('.header__li');
...
if(document.getElementById('mapid')){
  var mymap = L.map('mapid').setView([47.026859, 28.841551], 13);
...
var marker = L.marker([47.026859, 28.841551]).addTo(mymap);

};


if(document.getElementById('mapid_business')){
  var mymap = L.map('mapid_business').setView([47.026859, 28.841551], 13);
...
//aside
//Menu
let iconMenuAside = document.querySelector(".icon-menu-aside");
if (iconMenuAside != null) {
	let delay = 500;
	let menuBodyAside = document.querySelector(".page__aside");
	iconMenuAside.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			iconMenuAside.classList.toggle("_active");
			menuBodyAside.classList.toggle("_active");
		}
	});
};
function menu_close() {
	...
	let menuBodyAside = document.querySelector(".page__aside");
	iconMenu.classList.remove("_active");
	menuBodyAside.classList.remove("_active");
}
///tuch-menu

let iconMenuTouch = document.querySelector(".icon-menu-touch");

if (iconMenuTouch != null) {
	let delay = 500;
	let menuBodyTouch = document.querySelector(".touch-nav__menu");
	iconMenuTouch.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			iconMenuTouch.classList.toggle("_active");
			menuBodyTouch.classList.toggle("_active");
		}
	});
};
function menu_close() {
	let iconMenuAside = document.querySelector(".icon-menu-touch");
	let menuBodyTouch = document.querySelector(".touch-nav__menu");
	iconMenuTouch.classList.remove("_active");
	menuBodyTouch.classList.remove("_active");
}
...
let driverSlide = new Swiper('.driver-slide__items', {
	...
	// Arrows
	navigation: {
		nextEl: '.driver-slide__right',
		prevEl: '.driver-slide__left',
	},
...
let sliderClientsItems = new Swiper('.slider-clients__items', {
